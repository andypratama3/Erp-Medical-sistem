...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li>
                    <a class="font-medium" href="#">ACT /</a>
                </li>
                <li class="font-medium text-primary">Invoices</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex gap-3">
            <a href="{{ route('act.invoices.create') }}" class="inline-flex items-center justify-center gap-2.5 rounded-md bg-primary px-10 py-4 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10">
                <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10 0C10.5523 0 11 0.447715 11 1V9H19C19.5523 9 20 9.44772 20 10C20 10.5523 19.5523 11 19 11H11V19C11 19.5523 10.5523 20 10 20C9.44772 20 9 19.5523 9 19V11H1C0.447715 11 0 10.5523 0 10C0 9.44772 0.447715 9 1 9H9V1C9 0.447715 9.44772 0 10 0Z" fill=""/>
                </svg>
                Create Invoice
            </a>
        </div>
                ...
                <table class="w-full table-auto">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <span class="inline-flex rounded-full bg-{{ $invoice['status']['color'] }} bg-opacity-10 px-3 py-1 text-sm font-medium text-{{ $invoice['status']['color'] }}">
                                    {{ $invoice['status']['label'] }}
                                </span>
                            </td>
                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <div class="flex items-center space-x-3.5">
                                    <a href="{{ $invoice['actions']['show'] }}" class="hover:text-primary">
                                    ...
                                    <a href="{{ $invoice['actions']['edit'] }}" class="hover:text-primary">
                                        <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @empty
                        <tr>
                            <td colspan="{{ count($columns) + 1 }}" class="border-b border-[#eee] px-4 py-5 text-center dark:border-strokedark">
                                <p class="text-black dark:text-white">No invoices found.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
