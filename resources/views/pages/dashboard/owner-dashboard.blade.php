...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <!-- Stats Cards Grid -->
    <div class="grid grid-cols-2 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5 mb-6">
        <!-- Total Sales DO -->
        <div class="rounded-sm border border-stroke bg-amber-800 px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div class="mt-4 flex items-end justify-between">
                <div>
                    ...
                    <span class="text-sm font-medium dark:text-white">Total Sales DO</span>
                </div>
        ...
        <div class="rounded-sm border border-stroke bg-amber-800 px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div class="mt-4 flex items-end justify-between">
                <div>
                    ...
                    <span class="text-sm font-medium dark:text-white">Total Revenue</span>
                </div>
        ...
        <div class="rounded-sm border border-stroke bg-amber-800 px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div class="mt-4 flex items-end justify-between">
                <div>
                    ...
                    <span class="text-sm font-medium dark:text-white">Pending Deliveries</span>
                </div>
        ...
        <div class="rounded-sm border border-stroke bg-amber-800 px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div class="mt-4 flex items-end justify-between">
                <div>
                    ...
                    <span class="text-sm font-medium dark:text-white">Active Tasks</span>
                </div>

                <span class="flex items-center gap-1 text-sm font-medium text-meta-6">
                    ...
                    <div class="flex items-center gap-5 py-3 px-7.5 hover:bg-gray-3 dark:hover:bg-meta-4">
                        ...
                        <div class="flex flex-1 items-center justify-between">
                            ...
                            <div class="flex h-6 w-6 items-center justify-center rounded-full bg-primary">
                                <span class="text-sm font-medium text-white">{{ $task->sales_do_id }}</span>
                            </div>
                        </div>
                    </div>
                    @endforeach
...
function filterBranch(branchId) {
    ...
    event.target.classList.remove('border', 'border-primary', 'text-primary');
