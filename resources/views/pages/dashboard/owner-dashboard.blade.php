...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
    ...
    <div class="mb-6 flex flex-wrap gap-3">
        <button onclick="filterBranch('all')"
            class="branch-filter active inline-flex items-center justify-center rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-white hover:bg-opacity-90">
            All Branches
        </button>
        @foreach($branches as $branch)
        <button onclick="filterBranch({{ $branch->id }})"
            class="branch-filter inline-flex items-center justify-center rounded-md border border-primary px-5 py-2.5 text-sm font-medium text-primary dark:text-white hover:bg-primary hover:text-white hover:bg-opacity-90">
            {{ $branch->name }}
        </button>
        @endforeach
    </div>
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-2 md:gap-6">
        ...
        <!-- Total Revenue -->
        <div
            class="rounded-sm border border-stroke px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark p-5">
            <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4 p-5">
                        ...
                        <div class="flex min-w-47.5 ">
                            ...
                            <div class="w-full">
                                ...
                                <p class="dark:text-white text-sm font-medium">Rp
                                    {{ number_format($chartData['current_month'], 0, ',', '.') }}</p>
                            </div>
                        </div>
                        <div class="flex min-w-47.5">
                            <span
                            ...
                            <div class="w-full">
                                ...
                                <p class="dark:text-white text-sm font-medium">Rp
                                    {{ number_format($chartData['last_month'], 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
